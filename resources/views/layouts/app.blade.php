...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-dark shadow-sm">
            <div class="container">
                <a class="navbar-brand text-white" href="{{ url('/') }}">
                    ...
                    {{ config('app.name', 'IMS | Inventory Management System') }}
                </a>
    ...
    <footer class="footer fixed-bottom mt-auto py-3 bg-dark">
        <div class="container text-center">
            <span class="text-warning"><small>Designed & developed by <a href="http://www.linkedin.com/in/faraaz-electricwala" class="text-warning"> Er. Faraaz Electricwala</a></small></span>
        </div>
    </footer>
